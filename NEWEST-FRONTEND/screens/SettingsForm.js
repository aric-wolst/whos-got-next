...
class SettingsForm extends Component {
    ...
    updateProfile = async () => {
        ...
        var obj;
        var level;
        if(this.state.firstName === "" || this.state.gender === "" || this.state.description === "") {
            Alert.alert("Invalid Entry", "Please make sure to fill in at least your name, gender, and description.");
        } else {
    ...
    render() {
        ...
        const postButton = <Button ref = {this.props.generateTestHook('PostButton')} color = "#ff8c00" title = "Update Profile" onPress = {this.updateProfile}/>
        const disabledButton = <Button ref = {this.props.generateTestHook('DisabledButton')} disabled = {true} title = "Profile Updated!"/>
                ...
                <SafeAreaView style={styles.container}>
                    <ScrollView>
                        ...
                        <TextInput
                            ...
                            ref = {this.props.generateTestHook('GenderInput')}
                        />
                        <Text>Bio</Text>
                        <TextInput
                        ...
                        <View style = {styles.sportCard}>
                            ...
                            <Dropdown
                                ...
                                ref = {this.props.generateTestHook('BasketballLevelInput')}
                            />
                            <Button
                                disabled = {this.state.basketball[0]}
                                title = "Add"
                                onPress = {this.addBasketball}
                                ref = {this.props.generateTestHook('BasketballButton')}
                            />
                        </View>
...
const TestSettings = hook(SettingsForm);
